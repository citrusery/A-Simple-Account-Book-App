...
import java.util.List;
    ...
    public class PieChartManagger {
        ...
        private void initPieChart() {
            ...
            pieChart.setHoleColor(0xFFFAFAFB);
            ...
            pieChart.setCenterText("收支情况"); //设置中间文字
            ...
            pieChart.setEntryLabelColor(Color.BLUE); //描述文字的颜色
...
//        设置pieChart图表转动阻力摩擦系数[0,1]
 ...
 //           legend.setVerticalAlignment(Legend.LegendVerticalAlignment.CENTER); //顶部
 //           legend.setHorizontalAlignment(Legend.LegendHorizontalAlignment.RIGHT); //右对其

            legend.setXEntrySpace(5f);//x轴的间距
            legend.setYEntrySpace(10f); //y轴的间距
            legend.setYOffset(50f);  //图例的y偏移量
            legend.setXOffset(-30f);  //图例x的偏移量
...
//        显示试图
         ...
         * @param colors
         */
        public void  showRingPieChart(List<PieEntry> yvals, List<Integer> colors,boolean setpieview){
            //显示为圆环
            if(setpieview){
                pieChart.setDrawHoleEnabled(true);
                pieChart.setHoleRadius(50f);//设置中间洞的大小
            } else{
                pieChart.setDrawHoleEnabled(false);
            }
...
//        文字的大小
            dataset.setValueTextSize(14);
//        文字的颜色
            dataset.setValueTextColor(0xff80A6C0);
//        文字的样式
            dataset.setValueTypeface(Typeface.DEFAULT_BOLD);
