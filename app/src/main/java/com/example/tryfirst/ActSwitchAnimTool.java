    ...
    public class SwitchAnimView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            switch (getmAnimType()) {
                case MODE_SPREAD:
                    mSpreadPaint.setStrokeWidth(mRadius);
                    canvas.drawCircle(mCenterX, mCenterY, mRadius / 2 - 50 + mTargetCircleRadius, mSpreadPaint);
                    break;
                case MODE_SHRINK:
                    mShrinkPaint.setStrokeWidth(mRadius);
                    canvas.drawCircle(mCenterX, mCenterY, mRadius / 2 - 50 + mTargetCircleRadius, mShrinkPaint);
                    break;
            }
        }
